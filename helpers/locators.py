...
class Locators:
    ...
    SECTION_SAUCE = (By.XPATH, "//div[span[text()='Соусы']]") #Раздел соусы
    SECTION_BREAD = (By.XPATH, "//div[span[text()='Булки']]") #Раздел булки
    SECTION_FILLING = (By.XPATH, "//div[span[text()='Начинки']]") #Раздел начинки
    UL_SECTION_DREAD = (By.XPATH,"(//ul[@class='BurgerIngredients_ingredients__list__2A-mT'])[1]")#Область хлеб
    UL_SECTION_SAUCE = (By.XPATH,"(//ul[@class='BurgerIngredients_ingredients__list__2A-mT'])[2]")#Область соусы
    UL_SECTION_FILLING = (By.XPATH,"(//ul[@class='BurgerIngredients_ingredients__list__2A-mT'])[3]")#Область начинок